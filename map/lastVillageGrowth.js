...
var scriptConfig = {
    ...
    translations: {
        en_DK: {
            ...
            'Script is initializing...': 'Script is initializing...',
		...
		es_ES: {
            'Last Village Growth': 'Ultima Actividad',
            Help: 'Ayuda',
            'Redirecting...': 'Redireccionando',
            'Script is initializing...': 'Script se Inicia',
            'There was an error fetching information!':
                'Erro al buscar Informacion!',
            'Script is not allowed to be used on this TW market!':
                'Servidor no aceptado!',
        },
		fr_FR: {
            'Last Village Growth': 'Derniere Activite',
            Help: 'Aide',
            'Redirecting...': 'On y Va',
            'Script is initializing...': 'Demarrage du Script',
            'There was an error fetching information!':
                'Erro dans la recherche d info!',
            'Script is not allowed to be used on this TW market!':
                'Serveur non accepte!',
        },
    },
...
$.getScript('https://cdn.jsdelivr.net/gh/Joalban/scriptgt@main/profile/twSDK.js', async function () {
    ...
    UI.SuccessMessage(twSDK.tt('Script is initializing...'));
    ...
    initLastVillageGrowth();

    // Script business logic
    function initLastVillageGrowth() {
