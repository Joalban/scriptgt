...
var translations = {
    ...
    pt_PT: {
        ...
        'Script is already loaded!':
            'O script já foi executado e já está a funcionar!',
    },
    pt_BR: {
        'Extended Player Info': 'Mais informação do jogador',
        Help: 'Ajuda',
    ...
    fr_FR: {
        ...
        'Error while fetching "village.txt"!':
            'Erreur lors de la récupération "village.txt"!',
        'Points:': 'Points:',
        'Rank:': 'Rang:',
        'Player:': 'Joueur:',
        'All Villages Coords:': 'Toutes les coord.:',
        'Villages:': 'Villages:',
        'Toggle Graphs': 'Basculer les graphiques',
        'Toggle Coords': 'Basculer les coords',
        'Toggle Random Fake Scripts': 'Basculer les Fakes Scripts aléatoires',
        'Toggle Sequential Fake Scripts': 'Basculer les Fakes Scripts ordonnés',
        'TWStats Player Profile': 'TWStats Profil du joueur',
        'Show Player on Global Map': 'Montrer le joueur sur la carte du monde',
        'TribalWars Maps Player Profile': 'TribalWars Maps profil du joueur',
        'Village Coords for Continent':
            'Coordonnées du villages pour le continent',
        'village/s': 'village/s',
        'Script is already loaded!': "Script est déjà en cours d'exécution!",
    },
	es_ES: {
        ...
        'Error while fetching "village.txt"!':
            'Error al recuperar "village.txt"!',
        'Points:': 'Puntos:',
        'Rank:': 'Rango:',
        'Player:': 'Jugador:',
        'All Villages Coords:': 'Todos los Pueblos:',
        'Villages:': 'Pueblos:',
        'Toggle Graphs': 'Graficos',
        'Toggle Coords': 'Coordenadas',
        'Toggle Random Fake Scripts': 'Fake Scripts Aleatorios',
        'Toggle Sequential Fake Scripts': 'Fake Scripts Sequenciales',
        ...
        'village/s': 'pueblo/s',
        'Script is already loaded!': 'Script se esta ejecutando!',
    },
};
