...
var translations = {
    en_DK: {
        ...
        'Sequantial Cat Only Fake Script': 'Sequantial Cat Only Fake Script',
    },
    ro_RO: {
    ...
    fr_FR: {
        ...
        'Script is already running!': "Script en cours d'exécution!",
        'TW Stats': 'TW Stats',
        'TW Map Stats': 'TW Map Stats',
        'TW Map': 'TW Map',
...
function initTribeInfo() {
    if (jQuery('.tribe-info-shown').length < 1) {
        ...
        const tribeInfo = `
            <div class="ra-extended-tribe-info" id="extendedTribeInfo">
                ...
                <div class="extended-tribe-info-body">
                    ...
                    <div class="etib-box">
                        <label for="randomRamOnly">
                            ${tt('Random Cat Only Fake Script')}
                        </label>
                        <textarea id="randomRamOnly" readonly>${randomOnlyCats}</textarea>
                    </div>
                    <div class="etib-box">
                        <label for="sequentialRamOnly">
                            ${tt('Sequantial Cat Only Fake Script')}
                        </label>
                        <textarea id="sequentialRamOnly" readonly>${sequentialOnlyCats}</textarea>
                    </div>
                </div>
                <br>
                <small>
        ...
        jQuery('#contentContainer').addClass('tribe-info-shown');
        jQuery('#contentContainer').before(tribeInfo);
