...
function displayEverything() {
    ...
    $.each(playerData, function (playerName) {
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            ...
            html += `<td><table><tr><td class="item-padded">[img]</td><td class="item-padded"><img src="/graphic/unit/unit_${troopName}.png" title="${troopName}" alt="" class=""></td><td class="item-padded">[/img]</td>
