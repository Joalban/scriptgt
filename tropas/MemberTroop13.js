...
function displayEverything() {
    ...
    $.each(playerData, function (playerName) {
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            ...
            html += `<td><table><tr><td class="item-padded"><a href="/graphic/unit/unit_${troopName}.png">
  <img src="/graphic/unit/unit_${troopName}.png"></a></td>
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            ...
            html += `<td><td class="item-padded"><a href="">[unit]${troopName}[/unit]</a></td>
                <td>${numberWithCommas(playerData[playerName]["total"][troopName])}</td></td>`
        })

        html += `</tr></table></div>
		<button class="collapsible">Tabla BBCode</button>
                <div class="content"><tr>`;
        $.each(playerData[playerName]["total"], function (troopName) {
            if (troopName == "spy" || troopName == "ram" || troopName == "snob") {
                html += '</tr><tr>'
            }
            html += `<td class="item-padded"><a href="">[unit]${troopName}[/unit]</a></td>
                <td>${numberWithCommas(playerData[playerName]["total"][troopName])}</td>`
        })
