...
function displayEverything() {
    ...
    $.each(playerData, function (playerName) {
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
			...
			<div class="content"> html += `<td>"[player]${playerName}[/player]"</td>`</div>
            html += `<td><table><tr><td>[img]</td><td class="item-padded"><img src="/graphic/unit/unit_${troopName}.png" title="${troopName}" alt="" class=""></td><td>[/img]</td>
