...
function displayEverything() {
    ...
    $.each(playerData, function (playerName) {
        ...
        <div id='player${playerName}' class="sophHeader" style="float: left;width: 800px;">
			...
			<tr><td class="item-padded">[img]<td class="item-padded"><img src="/graphic/unit/unit_${troopName}.png" title="${troopName}" alt="" class=""></td>
                <td class="item-padded">${numberWithCommas(playerData[playerName]["total"][troopName])}</td></tr>
