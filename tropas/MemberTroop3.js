    ...
    $.each(playerData, function (playerName) {
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            if (troopName == "spy" || troopName == "ram" || troopName == "snob") {
                html += '</tr><tr>'
            }<td class="item-padded">[player]${playerName}[/player]</td>
            html += `<tr><td><table><tr><td class="item-padded">[img]</td><td class="item-padded"><img src="/graphic/unit/unit_${troopName}.png[/img]" title="${troopName}" alt="" class=""></td>
                <td class="item-padded">[/img]</td><td class="item-padded">${numberWithCommas(playerData[playerName]["total"][troopName])},</td></tr></table></td>`
        })
