...
function displayEverything() {
    ...
    $.each(playerData, function (playerName) {
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            ...
            html += `<td><table><tr><td>[img]</td><td class="item-padded"><a href="/graphic/unit/unit_${troopName}.png">
  <img src="/graphic/unit/unit_${troopName}.png"></a></td><td>[/img]</td>
        ...
        $.each(playerData[playerName]["total"], function (troopName) {
            ...
            html += `-[unit]<td>${troopName}</td>[/unit]<td class="item-padded">${numberWithCommas(playerData[playerName]["total"][troopName])}</td>'
        })
