 ...
 * javascript:$.getScript('https://cdn.jsdelivr.net/gh/Joalban/scriptgt@main/profile/playerinfo.js');
 * javascript:$.getScript('https://raw.githubusercontent.com/Joalban/scriptgt/main/profile/playerinfo.js');
 */
...
var scriptConfig = {
    ...
    translations: {
        ...
        es_ES: {
            ...
            'Rank:': 'Rango:',
            'Player:': 'Jugador:',
            'All Villages Coords:': 'Todos los Pueblos:',
            'Villages:': 'Pueblos:',
            'TWStats Player Profile': 'TWStats Perfil',
            'Show Player on Global Map':
                'Mostrar Jugador en TWMap',
            'TribalWars Maps Player Profile':
                'TribalWars Maps Perfil',
            'Village Coords for Continent':
                'Coordinadas por Continente',
            'village/s': 'pueblo/s',
...
$.getScript('https://raw.githubusercontent.com/Joalban/scriptgt/main/profile/twSDK.js', async function () {
    // Initialize Library
    ...
    function initExtendedPlayerInfo(playerId) {
        ...
        let randomOnlyScouts = `javascript:var lanca =00; var espada=00; var barbaro=00; var arqueiro=00; var explorador=01; var cavalaria_leve=30; var cavalaria_arqueira=00; var cavalaria_pesada=00; var catapulta=00; var ariete=00; var coords_ataque='${playerVillageCoordsString}'; var apoiar=false; var aviso=true; var cookieName="fakeapoio"; var repetir_ataques = 1; $.getScript("https://cdn.jsdelivr.net/gh/Joalban/scriptgt@main/fakepro.js"); void(0);`;
        let randomOnlyRams = `javascript:var lanca =00; var espada=00; var barbaro=00; var arqueiro=00; var explorador=01; var cavalaria_leve=30; var cavalaria_arqueira=00; var cavalaria_pesada=00; var catapulta=00; var ariete=00; var coords_ataque='${playerVillageCoordsString}'; var apoiar=true; var aviso=true; var cookieName="fakeapoio"; var repetir_ataques = 1; $.getScript("https://cdn.jsdelivr.net/gh/Joalban/scriptgt@main/fakepro.js"); void(0);`;
        ...
        const content = `
            ...
            <div class="ra-grid ra-mb15">
                <div>
                    <label class="ra-label" for="randomOnlyScouts">Fake Pro</label>
                    <textarea class="ra-textarea" readonly id="randomOnlyScouts">${randomOnlyScouts}</textarea>
                </div>
                <div>
                    <label class="ra-label" for="randomOnlyRams">Apoyos Pro</label>
