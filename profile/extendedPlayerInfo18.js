...
Solo linea - [*][player]${playerName}[/player][|][coord]${playerVillageCoordsString.trim()}[/coord][|][url=${twMapPlayerUrl}]Actividad Jugador[/url][|][url=${twStatusProfile}]Horarios Conexión[/url]</textarea>
            </div>
