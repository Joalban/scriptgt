    ...
    function initExtendedPlayerInfo(playerId) {
        ...
        const content = `
			...
			<div class="ra-mb15">
                ...
                <textarea class="ra-textarea" readonly id="allVillagesCoords">
				[table][**]Jugador[||]Pueblo[||]Actividad[||]Horarios[/**] 
[*][player]${playerName}[/player][|][coord]${playerVillageCoordsString.trim()}[/coord][|][url=${twMapPlayerUrl}]Actividad Jugador[/url][|][url=${twStatusProfile}]Horarios Conexión[/url][/table]</textarea>
            </div>
