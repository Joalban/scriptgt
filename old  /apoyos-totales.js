...
tableau+="	</tr>";
tableau+="	<tr>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_spear.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_sword.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_axe.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_spy.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_light.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_heavy.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_ram.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_catapult.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_snob.png?1'/></th>";
tableau+="	</tr>";
tableau+="	<tr>";
...
tableau+="		<td class='unit-item'>0</td>";
tableau+="	</tr>";
tableau+="	<button onclick = 'javascript: add();void(0);'>Calcular</button><br />";
tableau+="	<input id = 'tuti' name = 'illi' type ='checkbox'>Tropas en el Pueblo</input>";
tableau+="</table><p><i>Black Dragon</i></p>";
}
else {
var tableau = "";
tableau+="<table id = 'troupes_totales'>";
...
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_sword.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_axe.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_archer.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_spy.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_light.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_marcher.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_heavy.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_ram.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_catapult.png?1'/></th>";
tableau+="		<th width='50'><img src='http://cdn.tribalwars.net/graphic/unit/unit_snob.png?1'/></th>";
...
tableau+="	<button onclick = 'javascript: add();void(0);'>Calcular</button><br />";
tableau+="	<input id = 'tuti' name = 'illi' type ='checkbox'>Tropas en el Pueblo</input>";
tableau+="</table><i>Black Dragon</i>";
}
...
var troupes = $('table.vis[width="100%"] th:contains("Unidades")').parents('table').text().split('\n');
for (f = 0 ; f < troupes.length ; f++)	{
if(troupes[f].match(/\d+ Lancero?/))	{
	donn[0] = parseInt(troupes[f].match(/\d+/));
}
if(troupes[f].match(/\d+ Soldado con espada?/))	{
	donn[1] = parseInt(troupes[f].match(/\d+/));
}
if(troupes[f].match(/\d+ Soldado? con hacha/))	{
	donn[2] = parseInt(troupes[f].match(/\d+/));
}
if(troupes[f].match(/\d+ Arquero?/))	{
	donn[3] = parseInt(troupes[f].match(/\d+/));
}
if(troupes[f].match(/\d+ Espia?/))	{
